...
def fetch_options_chain(symbol="QQQ", access_token=None):
    ...
    # BUT need enough strikes to capture important levels like Put OI support
    # Using strikeCount=100 to get deeper OTM strikes (like $500 when price is $630)
    params = {
        "symbol": symbol,
        "contractType": "ALL",  # Both calls and puts
        "includeUnderlyingQuote": "true",
        "strategy": "SINGLE",
        "range": "ALL",  # Changed back to ALL to get wider range
        "strikeCount": 150  # Increased from 50 to get deeper strikes
        # Note: If this causes 502 errors, try "range": "OTM" with strikeCount=100
    }
